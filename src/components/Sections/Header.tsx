...
const Header: React.FC = () => {
  ...
  "
              >
                Crédito para{" "}
                <span className="text-custom-text-title">Expansão</span>. A
                Solução <span className="text-custom-text-title">Ideal</span>{" "}
                para
                <span className="text-custom-text-title">
                  {" "}
                  Industriais
                </span> e{" "}
                <span className="text-custom-text-title">Empresários</span>
              </h1>
              <p
            ...
            "
              >
                Vou mostrar a você que há alternativas mais eficientes do que
                investir seus próprios recursos para escalar seu faturamento.
                Existe uma maneira mais inteligente e eficaz para alcançar seus
                objetivos.
              </p>
            </div>
            <div className="hidden md:flex md:w-[400px] lg:w-[500px] xl:w-full z-20">
              <Button
                label="Quero saber mais sobre essa modalidade de crédito - Expansão."
                onClick={openModal}
              />
            </div>
          </div>
