    ...
    >
      <h2
        className="text-lg text-center font-bold pt-8 text-white
              ...
              "
      >
        O crédito para <span className="text-custom-text-title">expansão</span>{" "}
        é a opção mais <span className="text-custom-text-title">viável</span>,{" "}
        <span className="text-custom-text-title">econômica</span> e{" "}
        <span className="text-custom-text-title">segura</span> para{" "}
        <span className="text-custom-text-title">empreendedores</span> que
        desejam construir um negócio{" "}
      ...
      <p
        className="text-base text-center mt-4 font-normal text-white
            ...
            "
      >
        Além da expansão, há outras opções de crédito inteligente, incluindo:
      </p>
